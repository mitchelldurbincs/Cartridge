...
{line_range_start=35 line_range_end=48 path=docs/Individual Component Design/LEARNER.md git_url="https://github.com/mitchelldurbincs/Cartridge/blob/main/docs/Individual
Component Design/LEARNER.md#L35-L48"}{line_range_start=119 line_range_end=122 path=docs/Individual Component Design/LEARNER.md git_url="https://github.com/mitchelldurbincs/Cartridge/blob/main/docs/Individual

Component Design/LEARNER.md#L119-L122"}
Responsibilities & scope

    Accept weight publications emitted after each learner checkpoint, validating the (step, checksum, uri) manifest that the Python learner already produces when saving to object storage.{line_range_start=67 line_range_end=72 path=docs/Individual Component Design/LEARNER.md git_url="https://github.com/mitchelldurbincs/Cartridge/blob/main/docs/Individual

Component Design/LEARNER.md#L67-L72"}
...
{line_range_start=35 line_range_end=38 path=docs/Individual Component Design/LEARNER.md git_url="https://github.com/mitchelldurbincs/Cartridge/blob/main/docs/Individual
Component Design/LEARNER.md#L35-L38"}{line_range_start=119 line_range_end=122 path=docs/Individual Component Design/LEARNER.md git_url="https://github.com/mitchelldurbincs/Cartridge/blob/main/docs/Individual
...
Components
    ...
    Publish API – A gRPC surface offering PublishWeights so learners can push new versions immediately after checkpoints, matching the planned evolution called out in the learner design.{line_range_start=119 line_range_end=122 path=docs/Individual Component Design/LEARNER.md git_url="https://github.com/mitchelldurbincs/Cartridge/blob/main/docs/Individual

Component Design/LEARNER.md#L119-L122"}

Artifact validator – Confirms the learner-supplied checksum and metadata before promoting a version, aligning with the existing manifest format produced during checkpoint saves.{line_range_start=67 line_range_end=72 path=docs/Individual Component Design/LEARNER.md git_url="https://github.com/mitchelldurbincs/Cartridge/blob/main/docs/Individual
Component Design/LEARNER.md#L67-L72"}
...
Data lifecycle & storage
    ...
    The learner saves checkpoint shards plus a JSON manifest to object storage and computes a checksum.{line_range_start=67 line_range_end=72 path=docs/Individual Component Design/LEARNER.md git_url="https://github.com/mitchelldurbincs/Cartridge/blob/main/docs/Individual
...
Instrument gRPC handlers with tracing spans so Tempo/Jaeger visualisations can stitch the checkpoint-to-actor path together, consistent with the platform’s tracing strategy.{line_range_start=130 line_range_end=139 path=docs/Individual Component Design/LEARNER.md git_url="https://github.com/mitchelldurbincs/Cartridge/blob/main/docs/Individual

    Component Design/LEARNER.md#L130-L139"}
...
Flip learner configuration to the grpc backend and retire the Redis compatibility bridge once all actors use the new API.{line_range_start=119 line_range_end=122 path=docs/Individual Component Design/LEARNER.md git_url="https://github.com/mitchelldurbincs/Cartridge/blob/main/docs/Individual

    Component Design/LEARNER.md#L119-L122"}

Future work

    Support delta/segment streaming for very large models once the learner produces sharded artifacts in addition to the single-blob manifest.{line_range_start=67 line_range_end=72 path=docs/Individual Component Design/LEARNER.md git_url="https://github.com/mitchelldurbincs/Cartridge/blob/main/docs/Individual
